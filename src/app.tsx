...
import { buildTier1RatingRows, buildTier2Items } from "./feedbackAssets";
...
function Tier1Screen(props: {
  ...
  const { config, snapshot, realtimeStatus, ratings, onPickRating } = props;
  return (
    <div className="tier1">
      ...
      <div className="icon-grid">
        {categories.length === 0 ? (
          ...
          categories.map((item) => (
            ...
            >
              {item.iconSrc ? (
                <img className="icon-tile-symbol" src={item.iconSrc} alt="" aria-hidden="true" />
              ) : (
